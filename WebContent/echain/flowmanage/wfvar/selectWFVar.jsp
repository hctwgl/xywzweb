...
Map hm=WFVar.getInstance().mapName2ID;
...
<div id="leftMenuBar" style="height:470px; width:350; overflow: auto; text-align: left;">
	  ...
	  var path='<%=request.getContextPath()%>/echain/common/xtree/images/';
       ...
       var tree = new WebFXTree('请选择流程常量');
    <% 
       while(it.hasNext()){
    	   varname=(String)it.next();
    		varid=(String)hm.get(varname);
			out.print("tree.add(new WebFXTreeItem('"+varname+"',null,null,null,null,'"+varid+"@"+varname+"','"+count+"'));");	
        }
    %>
          tree.indentWidth = 19;
