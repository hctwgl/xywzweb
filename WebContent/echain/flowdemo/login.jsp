...
<center>
<font class=title>eChain易擎工作流平台流程演示</font>
<hr>
<br>
<table width="80%">
<tr><td align="right" width="40%">所属机构：</td><td align="left"><input type="text" id="orgname" value="" readonly="true">&nbsp;<a href=# onclick="selOrg()">选择</a></td></tr>
...
<a href="#" onclick="showhelp('关于流程演示demo','&nbsp;&nbsp;流程演示demo是eChain工作流引擎产品提供的基础功能模块，用户可以登陆该演示demo系统模拟发起审批任务以及进行任务办理，也可以跟踪查看某一个审批任务的办理历史痕迹.\n&nbsp;&nbsp;请使用系统注册的真实用户登陆该demo系统。')">关于流程演示demo</a>
</form>
</body>
</html>
