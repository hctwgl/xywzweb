...
%>
<tr class=trclass><td colspan='7'>没有任务信息</td></tr>
<%
}else{
	EVO vo;
	String nodestatus;
...
<a href="#" onclick="showhelp('我发起的任务','&nbsp;&nbsp;我发起的任务指处于审批过程中并且由当前登陆用户发起的业务审批办理的流程实例；\n&nbsp;&nbsp;可以输入指定的实例号进行查询，不输实例号缺省查询前20条实例记录。')">关于我发起的任务</a>
</body></html>
