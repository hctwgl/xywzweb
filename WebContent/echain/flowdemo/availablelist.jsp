...
%>
<tr class=trclass><td colspan='7'>没有可查看任务信息</td></tr>
<%
}else{
	EVO vo;
	String nodestatus;
...
<a href="#" onclick="showhelp('可查看任务','&nbsp;&nbsp;可查看实例指处于审批过程中并且当前登陆用户有权限查看的流程实例（当前用户未必参与过该流程实例的业务办理）；\n&nbsp;&nbsp;可以输入指定的实例号进行查询，不输实例号缺省查询前20条实例记录。')">关于可查看任务</a>
</body></html>
