...
<%
			...
			out.print("tree.add(new WebFXLoadTreeItem('"+rootOrgModel.getOrgname()+"','"+request.getContextPath()+"/echaincommonservlet?method=echaincommon&actionType=selectorg&orgid="+rootOrgModel.getOrgid()+"&count="+count+"',null,null,null,null,'"+rootOrgModel.getOrgid()+"@"+rootOrgModel.getOrgname()+"','"+count+"',null));");	 	 
		}
%>		  
		  tree.indentWidth = 19;
