...
<div id="leftMenuBar" style="height:470px; width:350; overflow: auto; text-align: left;">
	  ...
	  var path='<%=request.getContextPath()%>/echain/common/xtree/images/';
       ...
       var tree = new WebFXTree('请选择流程');
    <% 
       while(it.hasNext()){
			wfname=(String)it.next();
    		wfMap=(HashMap)wfMapList.get(wfname);
			out.print("tree.add(new WebFXTreeItem('"+wfname+"',null,null,null,null,'"+(String)wfMap.get("wfsign")+"@"+wfname+"','"+count+"'));");	
        }
    %>
          tree.indentWidth = 19;
