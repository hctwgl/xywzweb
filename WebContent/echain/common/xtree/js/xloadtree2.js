...
//update by guoxin
function WebFXLoadTreeItem(sText, sXmlSrc, oAction, eParent, sIcon, sOpenIcon, value, iptType, checked) {
	WebFXTreeItem.call(this, sText, oAction, eParent, sIcon, sOpenIcon, value, iptType, checked);
...
WebFXLoadTree._attrs = ["text", "src", "action", "id", "target","value", "iptType", "checked"];
...
WebFXLoadTree.createItemFromElement = function (oNode) {
	...
	var jsNode = new WebFXLoadTreeItem(jsAttrs.html || "", jsAttrs.src, action,
									   null, jsAttrs.icon, jsAttrs.openIcon,jsAttrs.value,jsAttrs.iptType,jsAttrs.checked);
	if (jsAttrs.text) {
