            ...
            coreAddPullToRefresh: function (rEl) {
                ...
                if (this.refreshElement === null) {
                    ...
                    if (orginalEl !== null) {
                        ...
                        afEl = $("<div id='" + this.container.id + "_pulldown' class='afscroll_refresh'>" + this.refreshContent + "</div>");
                    }
                } else {
