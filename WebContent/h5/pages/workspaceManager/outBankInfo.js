		...
		success : function(response){
			...
			for (var i = 0; i < aResults.length; i++) {
				li += '<div class="listRow">'
					+ '<a href="" style="font-size:25px" onclick="goToOutBankDetailPage('+aResults[i].ID+')">'+aResults[i].MESSAGE_TITLE+'</a>'
 ...
 * @param id
 */
function goToOutBankDetailPage(message_id) {
	goPage('outBankInfoDetail.html?id='+message_id);
}
