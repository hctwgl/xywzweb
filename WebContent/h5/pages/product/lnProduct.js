...
var tabPanelCfg = { tabItems :[{
                            	    ...
                            	    url     : basePath+'lnProductQueryAction.json', //查询URL
...
//                            				mesUtil.alert('无查询结果！');
                               				...
                               				for (var i = 0; i < response.json.data.length; i++) {
                               					...
                               					var li  = '<div class="bQ" onclick="goTodepLiabDetailPage2('+aResults[i].ID+')">'
                               						+'    <div class="bQL1">'
                               						+'        <p class="bQL1_sp">'
//                               						+ja
                               						+'        </p>'
                               						...
                               						+'    <div class="bQL2">'
                               						+'		  <p></br></p>'
                               						+'        <p class="bQL2P1" style="text-align:center">' + aResults[i].PROD_NAME+'</p>'
//                               						+'        <p class="bQL2P2" style="text-align:center">' + aResults[i].PROD_NO+'</p>'
                               					...
                               					if(i+1 < response.json.data.length) {
                               						i++;
                               						li += '<div class="bQ" onclick="goTodepLiabDetailPage2('+aResults[i].ID+')">'
                               							+'    <div class="bQL1">'
                               							+'        <p class="bQL1_sp">'
//                               							+ja
                               							+'        </p>'
