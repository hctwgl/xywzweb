...
var continentGroupRow2 = [ {
			...
			header : '非贸易融资单位贷款纯贷款日均增量',
			colspan : 7,
			align : 'center'
		}, {
			header : '单位贸易融资纯贷款日均增量',
			colspan : 7,
			align : 'center'
		}, {
			header : '个人贷款纯贷款日均增量',
			...
			header : '非贸易融资单位贷款纯贷款余额增量',
			colspan : 7,
			align : 'center'
		}, {
			header : '单位贸易融资纯贷款余额增量',
			colspan : 7,
			align : 'center'
		}, {
			header : '个人贷款纯贷款余额增量',
...
var record = Ext.data.Record.create( [ {
			...
			name : 'tableInQianx',
			mapping : 'TABLE_IN_QIANX'
		}, {
			name : 'tableOutQianx',
			mapping : 'TABLE_OUT_QIANX'
		}, {
			name : 'LxRecRate',
			mapping : 'LX_REC_RATE'
		}, {
...
var cm = new Ext.grid.ColumnModel( [ // rownum,
         {
			...
			width : 150,
			align : 'right',
			dataIndex : 'tableInQianx',
			sortable : true
		}, {
			header : '表外欠息增量',
			width : 150,
			align : 'center',
			dataIndex : 'tableOutQianx',
			sortable : true
		}, {
			header : '表外欠息本日余额',
			width : 150,
...
var memberData = {
	...
	rows : [ {
		...
		"LX_INCOME" : "100",
		"TABLE_IN_QIANX" : '2,000',
		"TABLE_OUT_QIANX" : "3,200",
		"LX_REC_RATE" : "0.7",
		"ADD_BECOME" : "520",
		"GLB_NUM" : "320",
		"JIE_SHOU_HUI" : "200",
