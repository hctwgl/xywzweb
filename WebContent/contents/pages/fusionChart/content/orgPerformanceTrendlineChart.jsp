...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <script type="text/javascript" src="orgPerformanceTrendlineChart.js"></script>
...
//        	}
        	...
        	function load() {
        		...
        		Ext.Ajax.request({
					url : basepath+'/orgPerformanceTrendline?customerId=' + parent.location.href.split("customerId=")[1] + '&crmDtStart=' + document.getElementById("crmDtStart").value + '&crmDtEnd=' + document.getElementById("crmDtEnd").value,
					method : 'GET',
