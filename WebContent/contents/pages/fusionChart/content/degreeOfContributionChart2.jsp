...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <script type="text/javascript" src="degreeOfContributionChart2.js"></script>
...
<!--         <script type="text/javascript" src="../tool/gallery_helper.js"></script> -->
		...
		<script type="text/javascript">
        	...
        	function load() {
        		...
        		/* var url = basepath+'/degreeofcontributionchart2?customerId=' + parent.parent.location.href.split("customerId=")[1] + '&crmDtStart=' + document.getElementById("crmDtStart").value + '&crmDtEnd=' + document.getElementById("crmDtEnd").value
	            chart.setDataURL(url);
	            chart.render("chartdiv"); */
	        	Ext.Ajax.request({
					url : basepath+'/degreeofcontributionchart2?customerId=' + parent.parent.location.href.split("customerId=")[1] + '&crmDtStart=' + document.getElementById("crmDtStart").value + '&crmDtEnd=' + document.getElementById("crmDtEnd").value,
					method : 'GET',
