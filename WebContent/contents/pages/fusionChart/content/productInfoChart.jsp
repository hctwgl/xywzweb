...
<!--         <script type="text/javascript" src="../tool/gallery_helper.js"></script> -->
		<script type="text/javascript" src="productInfoChart.js"></script>
		<script type="text/javascript">
		    function load() {
	            var chart = new FusionCharts(basepath+"/contents/pages/fusionChart/tool/MyColumn3D.swf", "ChartId", "100%", "100%", "0", "0");					
					Ext.Ajax.request({
						url : basepath+'/productInfoChart.json?customerId=' + parent.location.href.split("customerId=")[1],
						method : 'GET',
