 ...
 * @since 2012-11-08
 */
 Com.xywz.common.UserManagerIdQuery = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    onRender : function(ct, position){
    	Com.xywz.common.UserManagerIdQuery.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
    				...
    				if(!(_this.oCustomerQueryGrid.getSelectionModel().selections==null)){
						...
						for(var i=0;i<checkedNodes.length;i++){
							if(i==0){
								...
								oThisSearchField.hiddenField.setValue(checkedNodes[i].data.ACCOUNT_NAME);
							}else{
								sName=sName+','+checkedNodes[i].data.USER_NAME;
								oThisSearchField.hiddenField.setValue(_this.hiddenField.value+','+checkedNodes[i].data.ACCOUNT_NAME);
							}
						}
...
Ext.reg('userManagerIdQuery',Com.xywz.common.UserManagerIdQuery);