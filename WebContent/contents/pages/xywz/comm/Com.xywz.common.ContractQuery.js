 ...
 * @since 2015-10-20
 */
 Com.xywz.common.ContractQuery = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    onRender : function(ct, position){
    	Com.xywz.common.ContractQuery.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
    ...
    onTrigger2Click : function(){
    	...
    	_this.oContractFrgnQueryStore = new Ext.data.Store({
    		...
    		proxy : new Ext.data.HttpProxy(
											{
												url : basepath + '/XywzSaleOrdrContrQueryAction.json'}),
...
Ext.reg('ContractFrgnquery',Com.xywz.common.ContractQuery);