 ...
 * @since 2012-11-08
 */
 Com.xywz.common.WareInvtyAdjust = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    onRender : function(ct, position){
    	Com.xywz.common.WareInvtyAdjust.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
...
Ext.reg('customerquery',Com.xywz.common.WareInvtyAdjust);