						...
						items : [{
							...
							handler : function() {
								...
								if (selectLength != 1) {
									...
									editXywzPlanJobAdvsSnglForm.getForm().loadRecord(selectRe);
									editXywzPlanJobAdvsSnglWindow.show();

								}
							}
						},'-',{
							text : '<font color=red>反下达</font>',
							iconCls : 'addIconCss',
							handler : function() {
							var selectLength = grid.getSelectionModel().getSelections().length;
							if (selectLength < 1) {
							...
							Ext.MessageBox.confirm('提示','确定反下达吗?',function(buttonId){
								...
								//alert(idStr);
								Ext.Ajax.request({
									url : basepath+ '/XywzPlanPrdcPlanAdvsSnglAction!cancelScheduling.json',
