...
<DIV align=left name="cardInfo" id="PrintA">
	...
	Ext.Ajax.request({
		...
		url:basepath+"/XywzSaleInlandOrdrContrPrintAction!getInvInfo.json",
		method:'GET',
		async:false,	
		success:function (response){	
			var jsonData = Ext.decode(response.responseText);
			
			var CUST_NM=jsonData.CUST_FULL_NM;  //取全名称 
			var CONTR_NUM=jsonData.CONTR_NUM;
			var CONTR_DT=jsonData.CONTR_DT;
			var QLTY_TECH_STD_REQST=jsonData.QLTY_TECH_STD_REQST;
			var FINAL_TRAFF_DETAIL=jsonData.FINAL_TRAFF_DETAIL;
			var TRAFF_MODE=jsonData.TRAFF_MODE;
			var NGTV_POOR=jsonData.NGTV_POOR;
			var PKG=jsonData.PKG;
			var HESIT_PRD=jsonData.HESIT_PRD;
			var STL_MODE=jsonData.STL_MODE;
			...
			var invList = jsonData.saleInlandMerchdDtl;
			var htmlString='';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';		
			htmlString+='<TR>';
			htmlString+='<TD width="70%" height="20" align="left" colspan="5" style="font-size:14px;">需方： '+CUST_NM+'</TD>';
			htmlString+='<TD width="30%" height="20" align="left"  colspan="3" style="font-size:14px;">合同编号：'+CONTR_NUM+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';		
			htmlString+='<TR>';
			htmlString+='<TD width="70%" height="20" align="left" colspan="5" style="font-size:14px;">供方： 秦皇岛市国阳钢铁有限公司</TD>';
			...
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">二、质量技术标准要求：'+QLTY_TECH_STD_REQST+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">三、交（提）货地点、方式：'+FINAL_TRAFF_DETAIL+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">四、运输方式及到达站港和费用负担：'+TRAFF_MODE+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">五、合理损耗和计算方法：'+NGTV_POOR+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">六、包装标准、包装物的供应和回收：'+PKG+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">七、验收标准、方法及提出异议期限：'+HESIT_PRD+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">八、结算方式及期预付定金：'+STL_MODE+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			...
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">十、违约责任: 由违约方承担违约责任。 </TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">十一、解决合同纠纷的方式 ：双方协商，协商不成交当地司法机关仲裁。</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			...
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="1" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD width="50%" height="20" colspan="4" align="center"  style="font-size:14px;">供方</TD>';
			htmlString+='<TD width="50%" height="20" colspan="4" align="center"  style="font-size:14px;">需方</TD>';
			htmlString+='</TR>';
			htmlString+='<TR>';
			htmlString+='<TD width="50%" height="20" colspan="4" align="left"  style="font-size:14px;">单位名称: 秦皇岛市国阳钢铁有限公司</br>地址: 秦皇岛市卢龙县刘家营南</br>法定代表人: </br>委托代理人: </br>电话: 0335--7398118 </br>传真: 0335--7398088 </br>开户银行:卢龙县农行营业部</br>帐号: 828001040007633</TD>';
			htmlString+='<TD width="50%" height="20" colspan="4" align="left"  style="font-size:14px;">单位名称：'+CUST_NM+'</br>地址：'+ADDR+'</br>法定代表人：</br>委托代理人：</br>电话：'+TEL+'</br>传真：'+FAX+'</br>开户银行：'+BANK_FULL_NM+'</br>帐号：'+ACCT_NUM+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
