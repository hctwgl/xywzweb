...
<DIV align=left name="cardInfo" id="PrintA">
	<TABLE width="90%" align=center id="PrintA" border=0  cellpadding="0" cellspacing="0">
		<TR>
			<TD height="40" align="center" colspan="8" style="font-size:22px;FONT-FAMILY:\'Times New Roman\';">工 矿 产 品 加 工 合 同</TD>
		</TR>		
	</TABLE>
	...
	Ext.Ajax.request({
		...
		url:basepath+"/XywzAsstMachgContractMgmtPrintAction!getInvInfo.json",
		method:'GET',
		async:false,	
		success:function (response){	
			var jsonData = Ext.decode(response.responseText);
			var MACHG_ORDR_NM=jsonData.MACHG_ORDR_NM;
			var MACHG_CONTR_NUM=jsonData.MACHG_CONTR_NUM;
			var CONTR_DT=jsonData.CONTR_DT;
			var MEMO1=jsonData.MEMO1;
			var QLTY_REQST=jsonData.QLTY_REQST;
			var MEMO2=jsonData.MEMO2;
			var MEMO3=jsonData.MEMO3;
			var MEMO4=jsonData.MEMO4;
			var PKG_REQST=jsonData.PKG_REQST;
			var STL_MODE_AND_TERM=jsonData.STL_MODE_AND_TERM;
			...
			var SIGN_SITE=jsonData.SIGN_SITE;
			var totalSum=0;
			var totalAmt=0;
			//document.getElementById("contractNo").innerText='CONTRACT NO.'+CONTR_NUM;				
			var invList = jsonData.asstMachgProduct;
			var htmlString='';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';		
			htmlString+='<TR>';
			htmlString+='<TD width="70%" height="20" align="left" colspan="5" style="font-size:14px;">供方： '+MACHG_ORDR_NM+'</TD>';
			htmlString+='<TD width="30%" height="20" align="left"  colspan="3" style="font-size:14px;">合同编号：'+MACHG_CONTR_NUM+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';		
			htmlString+='<TR>';
			htmlString+='<TD width="70%" height="20" align="left" colspan="5"  style="font-size:14px;">&nbsp;</TD>';
			htmlString+='<TD width="30%" height="20" align="left" colspan="3"  style="font-size:14px;">签订地点：'+SIGN_SITE+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';		
			htmlString+='<TR>';
			...
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';		
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left" colspan="8" style="font-size:14px;">一、产品标的：</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			...
			htmlString+='<TD height="20" align="center" style="font-size:14px;">负差</TD>';
			...
			for(var i=0;i<invList.length;i++){
				...
				htmlString+='<TR>';
				htmlString+='<TD height="20" align="center" style="font-size:14px;">'+invList[i].fstNm+'</TD>';
				htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">'+invList[i].spcModel+'X'+invList[i].len+'M</TD>';
				htmlString+='<TD height="20" align="center" style="font-size:14px;">'+invList[i].ngtvPoor+'</TD>';
				htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">'+invList[i].pkg+'</TD>';
			...
			htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">-</TD>';
			htmlString+='<TD height="20" align="center" style="font-size:14px;">-</TD>';
			htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">合计吨数和金额</TD>';
			...
			htmlString+='</TR>';
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left" colspan="8" style="font-size:14px;">说明: '+MEMO1+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">二、质量技术标准要求：'+QLTY_REQST+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">三、交（提）货地点、方式：'+MEMO2+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">四、运输方式及到达站港和费用负担：'+MEMO3+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">五、合理损耗和计算方法：'+MEMO4+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">六、包装标准：'+PKG_REQST+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			...
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">八、结算方式及期限：'+STL_MODE_AND_TERM+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			...
			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">十、解决合同纠纷的方式 ：双方协商，协商不成交需方所在地司法机关仲裁 。</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">十一、其它约定事项：'+MEMO+'</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';

			htmlString+='<TABLE width="90%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';	
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left"  colspan="8" style="font-size:14px;">十二、传真件签字盖章生效。</TD>';
			htmlString+='</TR>';
			htmlString+='</TABLE>';
			...
			htmlString+='</TR>';
			htmlString+='<TR>';
			htmlString+='<TD width="50%" height="20" align="left" colspan="4"  style="font-size:14px;">单位名称：'+MACHG_ORDR_NM+'</br>地址：'+ADDR+'</br>法定代表人：</br>委托代理人：</br>电话：'+TEL+'</br>传真：'+FAX+'</br>开户银行：'+BANK_FULL_NM+'</br>帐号：'+ACCT_NUM+'</TD>';
