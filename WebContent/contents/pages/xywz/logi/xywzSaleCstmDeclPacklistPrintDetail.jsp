...
<DIV align=left name="cardInfo" id="PrintA">
	...
	<TABLE width="90%" align=left id="PrintA" border=0  cellpadding="0" cellspacing="0">
		<TR>
			<TD height="40" align="center" colspan="12" style="font-size:22px;FONT-FAMILY:\'Times New Roman\';">PACKING LIST </TD>
		</TR>		
	</TABLE>
	...
	Ext.Ajax.request({
		...
		url:basepath+"/XywzLogiCstmDeclPacklistPrintAction!getPackList.json",
		method:'GET',
		async:false,	
		success:function (response){	
			...
			htmlString+='<TD height="20" rowspan="4" colspan="5" align="left" style="font-size:14px;">'+CHKS_PERS+'</TD>';
			...
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">CONTRACT NO.:</TD>';
			htmlString+='<TD height="20" align="left" colspan="2" style="font-size:14px;">'+CONTR_NUM+'</TD>';
			htmlString+='</TR>';
			...
			htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">PCS/BUNDLE</TD>';
			htmlString+='<TD height="20" align="center" style="font-size:14px;">BUNDLES</TD>';
			htmlString+='<TD height="20" align="center" style="font-size:14px;">PCS</TD>';
			htmlString+='<TD height="20" align="center" colspan="5" style="font-size:14px;">NET WEIGHT AND GROSS WEIGHT PER EACH SIZE</TD>';
			htmlString+='</TR>';

			for(var i=0;i<invList.length;i++){
				f=parseFloat(invList[i].suttleGrossWeight);
				totalWeight+=f;	
				totalBundles+=invList[i].bundles;
				totalPcs+=invList[i].pcsBundle*invList[i].bundles;			
				htmlString+='<TR>';
				htmlString+='<TD height="20" align="center" colspan="3" style="font-size:14px;">'+invList[i].size+'</TD>';
				htmlString+='<TD height="20" align="center" colspan="2" style="font-size:14px;">'+invList[i].pcsBundle+'</TD>';
				htmlString+='<TD height="20" align="center" style="font-size:14px;">'+invList[i].bundles+'</TD>';
				htmlString+='<TD height="20" align="center" style="font-size:14px;">'+invList[i].pcsBundle*invList[i].bundles+'</TD>';
				htmlString+='<TD height="20" align="center" colspan="5" style="font-size:14px;">'+invList[i].suttleGrossWeight+'</TD>';
				htmlString+='</TR>';
			}
			...
			htmlString+='<TABLE width="70%" align=center valign="top" class="" id="PrintB"  border="0" cellpadding="0" cellspacing="0">';
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left" colspan="12" style="font-size:14px;">TOTAL WEIGHT:   '+totalWeight.toFixed(3)+'MT</TD>';
			htmlString+='</TR>';
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left" colspan="12" style="font-size:14px;">TOTAL BUNDLES:   '+totalBundles+'BUNDLES</TD>';
			htmlString+='</TR>';
			htmlString+='<TR>';
			htmlString+='<TD height="20" align="left" colspan="12" style="font-size:14px;">TOTAL PCS:   '+totalPcs+'PCS</TD>';
			htmlString+='</TR>';
			htmlString+='<TR>';
