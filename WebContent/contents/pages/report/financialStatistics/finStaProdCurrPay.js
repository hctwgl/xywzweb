...
/**********************************************************/
    ...
    function select(){
    	...
    	if(name =='1')
    	{
    		...
    		var url=basepath+'/reportJsp/showReport.jsp?raq=/report_8.2.raq&PRODNAME='+'聚财宝';
    	}
    	else if (name == '2'){
    		qForm.getForm().findField('pdname').setValue('');
    		var url=basepath+'/reportJsp/showReport.jsp?raq=/report_8.2.raq&PRODNAME='+'青花十二生肖';
    	}
    ...
    var viewport = new Ext.Panel({
    	title:'理财报表统计->附件银行个人理财产品->理财产品当期兑付金额份额表',
