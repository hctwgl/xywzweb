...
/**********************************************************/
    ...
    function select(){
		...
		{   
			...
			var url=basepath+'/reportJsp/showReport.jsp?raq=/report_2.2.raq&qdate='+'2009';
		}
		else if(dateyear=='2')
		{   
			Ext.getCmp("qyear").setValue('');
			var url=basepath+'/reportJsp/showReport.jsp?raq=/report_2.2.raq&qdate='+'2010';
		}
		else if(dateyear=='3')
		{   
			Ext.getCmp("qyear").setValue('');
			var url=basepath+'/reportJsp/showReport.jsp?raq=/report_2.2.raq&qdate='+'2011';
		}
		else if(dateyear=='4')
		{   
			Ext.getCmp("qyear").setValue('');
			var url=basepath+'/reportJsp/showReport.jsp?raq=/report_2.2.raq&qdate='+'2012';
		}
		else if(dateyear=='5')
		{   
			Ext.getCmp("qyear").setValue('');
			var url=basepath+'/reportJsp/showReport.jsp?raq=/report_2.2.raq&qdate='+'2013';
		}
    ...
    var viewport = new Ext.Panel({
    	title:'理财报表统计->附件银行个人理财产品->金融机构理财产品发售和到期情况汇总表',
