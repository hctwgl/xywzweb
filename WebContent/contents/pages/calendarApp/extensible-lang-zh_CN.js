...
if(Ext.ensible.cal.CalendarPanelCust) {
    Ext.apply(Ext.ensible.cal.CalendarPanelCust.prototype, {
        todayText: '今日',
        dayText: '日',
        weekText: '星期',
        monthText: '月',
...
if(Ext.ensible.cal.EventEditFormCust) {
    Ext.apply(Ext.ensible.cal.EventEditFormCust.prototype, {
        labelWidth: 65,
        labelWidthRightCol: 65,
        title: '事件来自',
        titleTextAdd: '添加事件',
