...
//						}
   		 ...
   		 var store = new Ext.data.Store({
				restful:true,	
		        proxy : new Ext.data.HttpProxy({url:basepath+'/branchVipAveBusScaleDetail.json'}),
		        reader: new Ext.data.JsonReader({
   		...
   		var cm = new Ext.grid.ColumnModel([rownum, 
   		                                {header : '日期',dataIndex : 'MONTH',width : 150,sortable : true},
   		                                    {header : '中心支行名称',dataIndex : 'ORG_NAME2',width : 150,sortable : true},
//   		                                    {header : '客户经理名称',dataIndex : 'CUST_MANAGER_NAME',width : 150,sortable : true},
   		                                    {header : '客户号',dataIndex : 'CUST_ID',width : 150,sortable : true},
   		                                    {header : '客户名称',dataIndex : 'CUST_NAME',width : 150,sortable : true},
   		                                    {header : '变动前等级',dataIndex : 'PRE_GRADE',width : 150,sortable : true},
   		                                    {header : '当前等级',dataIndex : 'CUR_GRADE_ORA',width : 150,sortable : true},
						...
						tbar : [
								...
								//导出处理函数部分
									 new Com.yucheng.bob.ExpButton({
										  ...
										  id:'exportbt',
										  url : basepath+'/branchVipAveBusScaleDetail.json?'
									  	})	
            ...
            var viewport = new Ext.Viewport( {
                ...
                items : [ {
                    ...
                    items : [ {
                        region : 'north',
                        id : 'north-panel',
                        title : "统计分析->零售报表->客户日均业务规模统计->支行客户日均业务规模统计明细",
                        height : 148,
                        hidden : false,
                        margins : '0 0 0 0',
                        // layout: 'fit',
