...
//						}
   		 ...
   		 var store = new Ext.data.Store({
				restful:true,	
		        proxy : new Ext.data.HttpProxy({url:basepath+'/branchVipAveBusScaleSum.json'}),
		        reader: new Ext.data.JsonReader({
						...
						tbar : [
								...
								//导出处理函数部分
									 new Com.yucheng.bob.ExpButton({
										  ...
										  id:'exportbt',
										  url : basepath+'/branchVipAveBusScaleSum.json?'
									  	})	
            ...
            var viewport = new Ext.Viewport( {
                ...
                items : [ {
                    ...
                    items : [ {
                        region : 'north',
                        id : 'north-panel',
                        title : "统计分析->零售报表->客户日均业务规模统计->支行客户日均业务规模汇总",
                        height : 148,
                        hidden : false,
                        margins : '0 0 0 0',
                        // layout: 'fit',
