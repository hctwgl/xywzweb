Ext
        .onReady(function() {
   		 ...
   		 var store = new Ext.data.Store({
				restful:true,	
		        proxy : new Ext.data.HttpProxy({url:basepath+'/custMgrVipCustomerAveAumDetail.json'}),
   		...
   		var cm = new Ext.grid.ColumnModel([rownum, 
   		                                 ...
   		                                 {header : '客户经理编号',dataIndex : 'CUST_MANAGER_ID',width : 150,sortable : true},
   		                                 ...
   		                                 {header : '网点名称',dataIndex : 'ORG_NAME4',width : 150,sortable : true},
						...
						tbar : [
								...
								//导出处理函数部分
									 new Com.yucheng.bob.ExpButton({
										  ...
										  id:'exportbt',
										  url : basepath+'/custMgrVipCustomerAveAumDetail.json?'
									  	})	
            ...
            var viewport = new Ext.Viewport( {
                ...
                items : [ {
                    ...
                    items : [ {
                        region : 'north',
                        id : 'north-panel',
                        title : "统计分析->零售报表->客户日均AUM统计->客户经理客户日均AUM明细",
                        height : 148,
                        hidden : false,
                        margins : '0 0 0 0',
                        // layout: 'fit',
