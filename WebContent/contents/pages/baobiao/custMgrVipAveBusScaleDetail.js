...
//						},
   		 ...
   		 var store = new Ext.data.Store({
				restful:true,	
		        proxy : new Ext.data.HttpProxy({url:basepath+'/custMgrVipAveBusScaleDetail.json'}),
		        reader: new Ext.data.JsonReader({
   		...
   		var cm = new Ext.grid.ColumnModel([rownum, 
   		                          ...
   		                          {header : '客户经理名称',dataIndex : 'CUST_MANAGER_NAME',width : 80,sortable : true},
   		                                 ...
   		                                 {header : '网点名称',dataIndex : 'ORG_NAME4',width : 80,sortable : true},
   		                                    ...
   		                                    {header : '客户名称',dataIndex : 'CUST_NAME',width : 80,sortable : true},
   		                                    {header : '变动前等级',dataIndex : 'PRE_GRADE_ORA',width : 80,sortable : true},
   		                                    {header : '当前等级',dataIndex : 'CUR_GRADE_ORA',width : 80,sortable : true},
						...
						tbar : [
								...
								//导出处理函数部分
									 new Com.yucheng.bob.ExpButton({
										  ...
										  id:'exportbt',
										  url : basepath+'/custMgrVipAveBusScaleDetail.json?'
									  	})	
            ...
            var viewport = new Ext.Viewport( {
                ...
                items : [ {
                    ...
                    items : [ {
                        region : 'north',
                        id : 'north-panel',
                        title : "统计分析->零售报表->客户日均业务规模统计->客户经理客户日均业务规模统计明细",
                        height : 148,
                        hidden : false,
                        margins : '0 0 0 0',
                        // layout: 'fit',
