 ...
 * @since 2013-03-04
 */
Com.yucheng.bcrm.common.MktActivityCommonQuery = Ext
		.extend(
				Ext.form.TwinTriggerField,
				{
					...
					onRender : function(ct, position) {
						Com.yucheng.bcrm.common.MktActivityCommonQuery.superclass.onRender
					...
					onTrigger2Click : function() {
						...
						_this.cm = new Ext.grid.ColumnModel([ _this.rownum,
								_this.sm, {
									...
									header : '计划开始日期',
									dataIndex : 'ACTI_PLAN_START_DATE',
									width : 100,
									sortable : true
								}, {
									header : '计划完成日期',
									dataIndex : 'ACTI_PLAN_END_DATE',
									width : 100,
									sortable : true
								}, {
									header : '实际开始日期',
						...
						_this.oCustomerQueryStore = new Ext.data.Store({
							...
							proxy : new Ext.data.HttpProxy({
								url : basepath
										+ '/mktActivityCommonQueryAction.json'
							}),
							reader : new Ext.data.JsonReader({
								...
								name : 'ACTI_PLAN_START_DATE'
							}, {
								name : 'ACTI_PLAN_END_DATE'
							}, {
...
Ext.reg('activityQuery', Com.yucheng.bcrm.common.MktActivityCommonQuery);