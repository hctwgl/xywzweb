/**
 * 营销管理->商机管理->我的商机：商机详情查看中的销售活动列表及详情查看JS文件；wzy；2013-02-28
 */
// 销售阶段
...
var cm_sales = new Ext.grid.ColumnModel([ rownum_sales, sm_sales, // 定义列模型
{
	header : '销售活动编号',
	dataIndex : 'SALES_ACTIV_ID',
	sortable : true,
	width : 120,
	hidden : true
}, {
	...
	header : '下次执行方式',
	dataIndex : 'NEXT_EXEC_WAY',
	sortable : true,
	width : 120,
	hidden : true
}, {
	header : '销售活动名称',
	dataIndex : 'SALES_ACTIV_NAME',
	sortable : true,
	width : 120
}, {
	header : '销售阶段',
	...
	header : '活动执行人',
	dataIndex : 'EXEC_USER_NAME',
	sortable : true,
	width : 80
}, {
	header : '活动执行机构',
	dataIndex : 'EXEC_ORG_NAME',
	sortable : true,
	width : 120
}, {
	header : '下次联系时间',
...
// 活动详情窗口From表单
var viewSalesActivViewForm = new Ext.FormPanel({
	labelWidth : 100,
	height : 250,
	frame : true,
	autoScroll : true,
...
function viewSalesActivInitView() {
	...
	viewSalesActivViewForm.getForm().reset();
	viewSalesActivViewForm.getForm().loadRecord(record);
