...
@Action(value="/XywzAsstMachgMgmtBankQueryAction", results={
    @Result(name="success", type="json")
})
public class XywzAsstMachgMgmtBankQueryAction extends BaseQueryAction {
	@Autowired
	@Qualifier("dsOracle")
	...
	public void prepare() {
    	...
    	StringBuilder sb=new StringBuilder("select t.* from xywz_asst_machg_mgmt_bank t  where 1=1 ");
