...
@Action(value="/XywzPlanPrdStateQueryAction", results={
    @Result(name="success", type="json")
})
public class XywzPlanPrdStateQueryAction extends BaseQueryAction {
	@Autowired
	@Qualifier("dsOracle")
	...
	public void prepare() {
    	...
    	StringBuilder sb=new StringBuilder("select t.* from XYWZ_PLAN_PRD_STATE t  " );
