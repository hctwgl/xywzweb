...
@Action(value="/XywzPlanJobAdvsSnglQueryAction", results={
    @Result(name="success", type="json")
})
public class XywzPlanJobAdvsSnglQueryAction extends BaseQueryAction {
	@Autowired
	@Qualifier("dsOracle")
	...
	public void prepare() {
    	...
    	StringBuilder sb=new StringBuilder("select t.* from XYWZ_PLAN_PRDC_PLAN_ADVS_SNGL t  where t.CHANNAL_TYPE='1' and t.SCHEDU_STATUS='1' ");
