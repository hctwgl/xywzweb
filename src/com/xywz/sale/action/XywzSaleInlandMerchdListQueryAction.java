...
@Action(value="/XywzSaleInlandMerchdListQueryAction", results={
    @Result(name="success", type="json")
})
public class XywzSaleInlandMerchdListQueryAction extends BaseQueryAction {
	@Autowired
	@Qualifier("dsOracle")
	...
	public void prepare() {
    	...
    	StringBuilder sb=new StringBuilder("select t1.* from XYWZ_SALE_INLAND_MERCHD_LIST t1  where 1=1 ");
