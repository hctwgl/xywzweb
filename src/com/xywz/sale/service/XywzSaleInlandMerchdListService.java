 ...
 */
@Service
public class XywzSaleInlandMerchdListService extends CommonService {
   
	public XywzSaleInlandMerchdListService(){
		JPABaseDAO<XywzSaleInlandMerchdList, Long>  baseDAO = new JPABaseDAO<XywzSaleInlandMerchdList, Long>(XywzSaleInlandMerchdList.class);  
