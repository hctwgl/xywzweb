...
import com.xywztech.bob.service.NewProductService;

@Action("/new-product")
@Results({
    @Result(name="success", type="redirectAction", params = {"actionName" , "new-product"})
})
public class NewProductAction  extends ValidationAwareSupport implements ModelDriven<Object>, Validateable{
    ...
    public HttpHeaders index() {
        list = newProductService.findAll();
    ...
    public String batchDestroy() {
        ...
        newProductService.batchRemove(idStr);
        addActionMessage("WorkingplatformInfo removed successfully");
        return "success";
    }
    ...
    public void setId(Long ID) {
        if (ID != null) {
            this.model = newProductService.find(ID);
        }
        this.ID = ID;
    }
