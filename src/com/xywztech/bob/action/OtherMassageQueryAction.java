...
@Action(value = "/otherMassageQuery", results = { @Result(name = "success", type = "json"), })
public class OtherMassageQueryAction extends BaseQueryAction {
