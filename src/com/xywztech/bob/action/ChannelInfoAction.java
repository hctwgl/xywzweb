...
import com.xywztech.bob.service.ChannelInfoService;

@SuppressWarnings("serial")
@Action("/channel-info")
public class ChannelInfoAction  extends CommonAction{
    @Autowired
    private ChannelInfoService channelInfoService ;
    @Autowired
	public void init(){
	  	model = new ChannelInfo(); 
		setCommonService(channelInfoService);
  ...
  //（自定义）批量删除
	...
	public String batchDestroy(){
			...
			String jql="delete from ChannelInfo c where c.channelId in ("+idStr+")";
			Map<String,Object> values=new HashMap<String,Object>();
	        channelInfoService.batchUpdateByName(jql, values);
