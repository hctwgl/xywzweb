...
@Action(value = "/manageMassageQuery", results = { @Result(name = "success", type = "json"), })
public class ManageMassageQueryAction extends BaseQueryAction {
