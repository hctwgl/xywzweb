...
@Results({
    @Result(name="success", type="redirectAction", params = {"actionName" , "GroupInfoAction"})
})
public class GroupInfoAction  extends ValidationAwareSupport implements ModelDriven<Object>, Validateable{
