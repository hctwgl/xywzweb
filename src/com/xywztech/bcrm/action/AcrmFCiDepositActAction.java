...
@Action(value="/acrmFCiDepositAct-info", results={
    @Result(name="success", type="json")
})
public class AcrmFCiDepositActAction extends BaseQueryAction {
	@Autowired
	@Qualifier("dsOracle")
	...
	public void prepare() {
    	...
    	StringBuilder sb=new StringBuilder("select distinct c.* from ACRM_F_CI_DEPOSIT_ACT c left join OCRM_F_CI_ACC_BELONG t on c.account = t.account  where 1=1 ");
    	//增加客户关联条件
