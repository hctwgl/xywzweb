...
public class OcrmFWpRemind implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="OCRM_F_WP_REMIND_ID_GENERATOR", sequenceName="ID_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="OCRM_F_WP_REMIND_ID_GENERATOR")
	private long id;
	...
	public BigDecimal getMsgLast() {
		return this.msgLast;
	}

	public void setMsgLast(BigDecimal msgLast) {
	...
	public BigDecimal getWhqs() {
		return this.whqs;
	}

	public void setWhqs(BigDecimal whqs) {
		this.whqs = whqs;
	}
