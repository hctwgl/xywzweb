 ...
 */
@Entity
@Table(name="OCRM_F_CSC_CARD_FORM")
public class OcrmFCscCardForm implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "SEQ_OCRM_F_CSC_CARD_FORM_GENERATOR", sequenceName = "SEQ_OCRM_F_CSC_CARD_FORM",allocationSize = 1)
	@GeneratedValue(generator = "SEQ_OCRM_F_CSC_CARD_FORM_GENERATOR", strategy = GenerationType.SEQUENCE)
	 ...
	 * 事件细项    1：申请进度
				...
				0：其他
	 */
	/*@Column(name="EVENT_FINE_ITEM")
	private Integer eventFineItem;*/
