 ...
 */
@Entity
@Table(name="OCRM_WP_F_ANNEXE")
public class OcrmWpFAnnexe implements Serializable {
	
	@Id
	@SequenceGenerator(name="OCRM_WP_F_ANNEXE_ID_GENERATOR", sequenceName="ID_SEQUENCE" ,allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="OCRM_WP_F_ANNEXE_ID_GENERATOR")
