...
@Action("/assurerInformation-info")
	public class AssurerInformationAction extends BaseQueryAction {
	...
	HttpServletRequest request;
		...
		public void prepare() {
			...
			StringBuilder sb = new StringBuilder("select t.* from acrm_f_ci_assurer_info t where 1>0 ");
