...
@Action("/cust_bel_org_info")
	public class CustBelOrgInfoAction extends BaseQueryAction {
		...
		public void prepare() {
			...
			StringBuilder sb = new StringBuilder("select t.* from OCRM_F_CI_BELONG_ORG t where 1>0 ");
