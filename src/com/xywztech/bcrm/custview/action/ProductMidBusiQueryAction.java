...
@Action(value="/productMidBusiQuery", results={
    @Result(name="success", type="json"),
})
public class ProductMidBusiQueryAction extends BaseQueryAction{
	@Autowired
@Qualifier("dsOracle")	
