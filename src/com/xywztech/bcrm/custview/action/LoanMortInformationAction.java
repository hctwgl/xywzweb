...
@Action("/loanMortInformation-info")
	public class LoanMortInformationAction extends BaseQueryAction {
	...
	HttpServletRequest request;
		...
		public void prepare() {
			...
			StringBuilder sb = new StringBuilder("select t.* from acrm_f_ci_loan_mort_info t where 1>0 ");
			...
			addOracleLookup("MORT_THING_TYPE", "CDE0100082");
			addOracleLookup("WARRANT_CARD_TYPE", "CDE0100025");
			addOracleLookup("OWNER_CARD_TYPE", "CDE0100025");
			addOracleLookup("REG_STAT", "CDE0100012");
			addOracleLookup("POSTING_STAT", "CDE0100026");
