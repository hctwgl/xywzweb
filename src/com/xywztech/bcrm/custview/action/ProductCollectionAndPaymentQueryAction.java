...
@Action(value="/productCollectionAndPaymentQuery", results={
    @Result(name="success", type="json"),
})
public class ProductCollectionAndPaymentQueryAction extends BaseQueryAction{
	@Autowired
	@Qualifier("dsOracle")	
