...
@Action("/loanImpaInformation-info")
	public class LoanImpaInformationAction extends BaseQueryAction {
	...
	HttpServletRequest request;
		...
		public void prepare() {
			...
			StringBuilder sb = new StringBuilder("select t.* from acrm_f_ci_loan_impa_info t where 1>0 ");
