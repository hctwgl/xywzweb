...
@Action(value="/productManageFinancesQuery", results={
    @Result(name="success", type="json"),
})
public class ProductManageFinancesQueryAction extends BaseQueryAction{
	@Autowired
	@Qualifier("dsOracle")	
	...
	public void prepare() {
        ...
        StringBuilder sb = new StringBuilder("SELECT t1.*,t2.PROD_NAME " +
        		"FROM ACRM_F_NI_FINANCING  t1 " +
