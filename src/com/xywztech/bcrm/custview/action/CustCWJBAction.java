...
@Action(value="/cust_cwjb", results={
    @Result(name="success", type="json")})
public class CustCWJBAction extends BaseQueryAction {
	...
	public void prepare() {
		...
		StringBuilder sb = new StringBuilder("" +
				...
				"left join ACRM_F_CI_CRD_KHJHCWB B on A.CUSTOM_ID=B.CUSTOM_ID and A.YEAR=B.YEAR and A.MONTH=B.MONTH and A.TIME_TYP=B.DATATIME");		
		setPrimaryKey("B.ID");
