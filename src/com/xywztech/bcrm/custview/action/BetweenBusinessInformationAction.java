...
@Action("/betweenBusinessInformation-info")
	public class BetweenBusinessInformationAction extends BaseQueryAction {
    ...
    private HttpServletRequest request;
		...
		public void prepare() {
			...
			StringBuilder sb = new StringBuilder("select t.* from acrm_f_ci_gk_zjyw t where 1>0 and t.cust_id" +
					"= '"+customerId+"' ");
