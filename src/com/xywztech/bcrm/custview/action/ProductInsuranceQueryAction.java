...
@Action(value="/productInsuranceQuery", results={
    @Result(name="success", type="json"),
})
public class ProductInsuranceQueryAction extends BaseQueryAction{
	@Autowired
	@Qualifier("dsOracle")	
...
//        		"FROM ACRM_F_NI_COLL_PAY_INSURANCE as t1 " +
